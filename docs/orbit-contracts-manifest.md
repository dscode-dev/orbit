...
Última revisão: PR Frontend-17 (Workforce Management).
...
| Sem edição de membro, troca de papel ou escrita da situação da associação                                                            | as ações são declaradas indisponíveis no Action Registry                                                                                                                                                                                              |
