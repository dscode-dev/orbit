...
import { EmptyState, LoadingState, Spinner } from "@/components/feedback/states";
...
const tableRows = [
  { id: "ORB-1042", modulo: "Operações", estado: "Ativo", owner: "A. Souza", progresso: 82 },
  { id: "ORB-1043", modulo: "Inventário", estado: "Em revisão", owner: "M. Lima", progresso: 46 },
  { id: "ORB-1044", modulo: "Pessoas", estado: "Rascunho", owner: "J. Prado", progresso: 12 },
];
  ...
  return (
    ...
    >
      <ContentContainer size="wide" className="space-y-12 pb-20">
          ...
          <div className="relative flex flex-col gap-6">
            ...
            <div className="space-y-3">
              ...
              <h1 className="max-w-2xl text-3xl font-semibold sm:text-4xl">
                O sistema de design do <span className="text-gradient-orbit">Orbit</span>
              </h1>
              <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                Tokens, componentes e layout base construídos a partir da identidade da marca —
                espaço profundo, órbita e luz. Toda tela futura da plataforma nasce daqui.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" onClick={() => toast.success("Toast do design system")}>
                Ver toast
              </Button>
            </div>
          </div>
        ...
        {/* Palette */}
        <Block title="Paleta & tokens" description="Derivada da logo: navy profundo, azul orbital e violeta de nebulosa.">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {paletteTokens.map((token) => (
              <div key={token.name} className="glass rounded-xl p-3">
                <div className={`h-14 w-full rounded-lg ring-1 ring-border ${token.swatch}`} />
        ...
        <Block title="Métricas" description="StatCard, KPI Card e Progress.">
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatCard label="Ordens ativas" value="1.284" delta="+12,4%" trend="up" hint="vs. mês anterior" icon={<Activity className="size-4" />} />
            <StatCard label="Lead time médio" value="3,2 d" delta="-8,1%" trend="down" hint="melhorou" icon={<Boxes className="size-4" />} />
        ...
        {/* Forms */}
        <Block title="Formulários" description="Input, Textarea, Select, MultiSelect, Checkbox, Radio e Switch.">
            ...
            <CardContent className="grid gap-6 pt-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="ds-search" className="pl-9" placeholder="Filtrar resultados" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Textarea id="ds-notes" placeholder="Descreva o contexto…" rows={3} />
              </div>
        ...
        {/* Actions & overlays */}
        <Block title="Ações & overlays" description="Button, Badge, Tooltip, Popover, Dropdown, Dialog e Drawer.">
          <Card className="glass-panel">
            <CardContent className="flex flex-wrap items-center gap-3 pt-6">
              ...
              <Popover>
                ...
                <PopoverContent className="text-sm">Conteúdo flutuante em vidro.</PopoverContent>
              </Popover>
              ...
              <Drawer>
                ...
                <DrawerContent>
                  <DrawerHeader>
                    ...
                    <DrawerDescription>Ideal para edição contextual em mobile.</DrawerDescription>
                  </DrawerHeader>
                </DrawerContent>
              </Drawer>
            </CardContent>
        ...
        {/* Data */}
        <Block title="Dados" description="Table, Pagination, Tabs e Accordion.">
          <SplitLayout
            ratio="2/1"
            primary={
              <Card className="glass-panel">
                <CardHeader>
                  ...
                  <CardDescription>Estrutura base para DataTables dos módulos.</CardDescription>
                </CardHeader>
                    ...
                    <TableBody>
                      {tableRows.map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell className="text-right">{row.progresso}%</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
              ...
              <Card className="glass-panel h-full">
                ...
                <CardContent>
                  <ScrollablePanel maxHeight="18rem" className="pr-2">
                    <Timeline
                      items={[
                        { title: "Tokens publicados", timestamp: "09:12", tone: "success", description: "Paleta derivada da logo." },
                        { title: "Sidebar revisada", timestamp: "10:04" },
                        { title: "Command palette", timestamp: "11:20", tone: "warning" },
                        { title: "Auditoria de contraste", timestamp: "13:47" },
                      ]}
                    />
                  </ScrollablePanel>
                </CardContent>
          ...
          <Tabs defaultValue="tab1">
            ...
            <TabsContent value="tab1" className="glass mt-3 rounded-xl p-4 text-sm text-muted-foreground">
              Conteúdo da aba de visão geral.
            </TabsContent>
            <TabsContent value="tab2" className="glass mt-3 rounded-xl p-4 text-sm text-muted-foreground">
              Conteúdo detalhado.
            </TabsContent>
            <TabsContent value="tab3" className="glass mt-3 rounded-xl p-4 text-sm text-muted-foreground">
          ...
          <Accordion type="single" collapsible className="glass rounded-xl px-4">
            <AccordionItem value="a1">
              <AccordionTrigger>Como criar um novo componente?</AccordionTrigger>
              <AccordionContent>
                Componha primitivas existentes, use apenas classes derivadas de tokens e exponha
                variantes com CVA.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="a2" className="border-b-0">
              <AccordionTrigger>Posso usar cores literais?</AccordionTrigger>
              <AccordionContent>Não. Todo valor visual vive em src/styles.css.</AccordionContent>
            </AccordionItem>
          </Accordion>
        </Block>

        {/* Feedback */}
        <Block title="Feedback & estados" description="Alert, Skeleton, Spinner, Loading e Empty State.">
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="space-y-4">
              <Alert>
                <Sparkles className="size-4" />
                <AlertTitle>Fundação pronta</AlertTitle>
                <AlertDescription>Os módulos do ERP podem ser construídos sobre esta base.</AlertDescription>
              </Alert>
        ...
        {/* Charts + calendar */}
        <Block title="Gráficos & calendário" description="Wrapper padrão para Recharts e seletor de datas.">
          <div className="grid gap-4 lg:grid-cols-2">
            <ChartWrapper title="Throughput" description="Wrapper reutilizável para qualquer gráfico.">
